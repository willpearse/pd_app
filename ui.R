...
fluidPage(
    ...
    sidebarLayout(
        sidebarPanel(
            ...
            tags$a(href="http://github.com/willpearse/pd_app/", "For an example of Newick format, click here!"),
            ...
            tags$a(href="http://github.com/willpearse/pd_app/", "For an example of the format, click here!"),
